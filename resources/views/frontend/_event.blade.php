                                ...
                                <div class="row g-4">
                                    @foreach ($event_live_musik as $live_musik)
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="event-img position-relative">
                                                <img class="img-fluid rounded w-100"
                                                    src="{{ asset('storage/' . $live_musik->image) }}"
                                                    alt="{{ $live_musik->name }}">
                                                <div class="event-overlay d-flex flex-column p-4">
                                ...
                                <div class="row g-4">
                                    @foreach ($event_nonton_bareng as $nonton_bareng)
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="event-img position-relative">
                                                <img class="img-fluid rounded w-100"
                                                    src="{{ asset('storage/' . $nonton_bareng->image) }}"
                                                    alt="{{ $nonton_bareng->name }}">
                                                <div class="event-overlay d-flex flex-column p-4">
                                ...
                                <div class="row g-4">
                                    @foreach ($event_game_night as $game_night)
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="event-img position-relative">
                                                <img class="img-fluid rounded w-100"
                                                    src="{{ asset('storage/' . $game_night->image) }}"
                                                    alt="{{ $game_night->name }}">
                                                <div class="event-overlay d-flex flex-column p-4">
