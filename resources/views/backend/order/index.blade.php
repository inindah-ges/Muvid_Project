                                ...
                                <tbody>
                                    @forelse($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-sm bg-gradient-{{ $order->payment_status_badge }}">
                                            ...
                                            <td>
                                                <div class="d-flex gap-1 justify-content-center">
                                                    ...
                                                    @if (auth()->user()->isAdmin() && $order->canBeConfirmed())
                                                        <form action="{{ route('panel.order.confirm', $order->uuid) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                    ...
                                                    @if (auth()->user()->isAdmin() && $order->canBeCompleted())
                                                        <form action="{{ route('panel.order.complete', $order->uuid) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <button type="submit" class="btn btn-success btn-md"
                                                    ...
                                                    @if (auth()->user()->isAdmin() && $order->canBeCancelled())
                                                        <form action="{{ route('panel.order.cancel', $order->uuid) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
            ...
            <div class="modal-content">
                ...
                <form id="paymentForm" action="" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="cashPaymentFields" class="mt-3" style="display: none;">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control border px-3" id="paymentAmount"
                                    name="payment_amount" min="0" step="1000">
                                <div class="mt-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="submitPayment" disabled>Process
                            Payment</button>
                    </div>
                </form>
            </div>
